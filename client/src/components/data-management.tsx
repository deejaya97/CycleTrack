  ...
  const importData = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Imported ${importedData.periods.length} periods and ${importedData.symptoms.length} feeling entries.`,
      });
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4 text-center">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600">Feeling Records</div>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-gray-600">
            Download your period tracking data as a JSON file. This includes all your period entries and feeling records.
          </p>
